        ...
        <div class="white_box QA_section card_height_100">
            <div class="white_box_tittle list_header m-0 align-items-center mb-3">
                <div class="main-title mb-sm-15">
                    <h3 class="m-0 nowrap">ADD NEW STUDENT</h3>
                </div>
            </div>
                ...
                <div class="centerForm">
                    <form class="projectForm" method="POST" action="handlers/add-advisor.php">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="interest" id="interest" cols="30" rows="3" class="form-control form-control-lg" placeholder="Enter interests or domain..."></textarea>
                        </div>
