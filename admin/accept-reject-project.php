        ...
        <div class="white_box QA_section card_height_100">
            <div class="white_box_tittle list_header m-0 align-items-center mb-3">
                <div class="main-title mb-sm-15">
                    <h3 class="m-0 nowrap">REVIEW PROJECT</h3>
                </div>
            ...
            <div class="QA_table overflow-auto">
                ...
                <form method="POST" action="handlers/reject.php">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top">
                                    <ul class="list-group">
                                        <li class="list-group-item"><?php echo $res["reg1"] ?></li>
                                        <li class="list-group-item"><?php echo $res["reg2"] ?></li>
                                        <li class="list-group-item"><?php echo $res["reg3"] ?></li>
                                    </ul>
                                </td>
                                <td style="vertical-align: top">
                                    <a href="handlers/accept.php?gid=<?php echo $res['id']; ?>&nid=<?php if (isset($_GET["nid"])) echo $_GET['nid']; ?>&aid=<?php if (isset($_GET["aid"])) echo $_GET['aid']; ?>" class="but">Approve</a>
                                </td>
                                <td style="vertical-align: top">
                    ...
                    <div class="form-group formRow">
                        <input type="hidden" name="ptitle" value="<?php echo $res["ptitle"] ?>">
                        <input type="hidden" name="aid" value="<?php if (isset($_GET["aid"])) echo $_GET["aid"] ?>">
