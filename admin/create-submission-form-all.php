            ...
            <div class="QA_table">
                <div class="main_content_iner">
                    <table class="table">
                        ...
                        <tbody>
                            <form action="handlers/create-submission-all.php" method="POST">
                                <tr>
                                    <td>
                            ...
                            $res = $submission->displayAllSubmissions();
                            if ($res->num_rows > 0) {
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col"><a href="edit-submission-form-all?title=<?php echo $row["title"] ?>&date=<?php echo $row["date"] ?>&time=<?php echo $row["time"] ?>">Edit</a></td>
                                    </tr>
