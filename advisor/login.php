...
<head>
    ...
    <title>Project Flow - Advisor Login</title>
...
<body>
    ...
    <div class="login-container d-flex align-items-center justify-content-center">
        <form class="login-form text-center" method="POST" action="handlers/login.php">
            ...
            <h2 class="mb-5">Advisor Login</h2>
            <div class="form-group">
                <input type="text" name="email" class="form-control rounded-pill form-control-lg" placeholder="Email">
            </div>
            <div class="form-group">
